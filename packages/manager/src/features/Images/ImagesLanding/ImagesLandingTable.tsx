              ...
              headerProps={{
                ...
                description: (
                  <>
                    ...
                    images you manually uploaded or captured from an existing
          ...
          <SafeTabPanel index={2}>
            <ImagesTable
              ...
              headerProps={{
                ...
                description: (
                  <>
                    These are images we automatically capture when Linode disks
                    are deleted. They will be deleted after the indicated
                    expiration date.
                  </>
                ),
              }}
