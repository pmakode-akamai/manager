...
describe('Firewall rule action menu', () => {
  it('should include the correct actions when rowType is rule', async () => {
  ...
  it('should include the correct actions when rowType is ruleset', async () => {
    const { getByText, queryByText, queryByLabelText, findByRole } =
      renderWithTheme(<FirewallRuleActionMenu {...props} rowType="ruleset" />);
