...
export const AssignRuleSetToFirewall = (
  ...
  return (
    <Box>
      <Typography sx={(theme) => ({ marginTop: theme.spacingFunction(16) })}>
        ...
        same fields as individual rules. They let you manage and update multiple
        rules as a group. You can then apply them across different firewalls by
        reference.
      </Typography>
      <Autocomplete
